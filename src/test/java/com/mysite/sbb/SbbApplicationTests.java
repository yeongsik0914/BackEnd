...
class SbbApplicationTests {
	...
	public void insertAnswer() {
		...
		a.setContent("3번 글에 대한 답변 입니다. - 3 " );
	...
	*/
	...
	public void testjpa () {
		...
		List<Question> all2 = this.questionRepository.findByContentLike("%내용%");
	...
	*/
	 ...
	 * Question 테이블 Primary Key 컬럼은 기본적으로 제공됨 : findById()
	@Test
	...
	*/
	...
	public void jpaTest() {
		...
		//assertEquals(14, all.size());		// assertEquals(기대값, 실제값) , 성공 (두 값이 일치)
